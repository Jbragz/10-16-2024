...
<div class="container">
    ...
    <button id="show-owners-btn" onclick="showOwnersModal()">Show All</button>
     <?php endif; ?>
        </div>
        ...
        <div class="customers-container">
            ...
            <?php if (count($customers) > 0): ?>
                ...
                <button id="show-customers-btn" onclick="showCustomersModal()">Show All</button>
                <?php endif; ?>
            <?php else: ?>
...
<!-- Modal for Owners -->
<div id="owners-modal" class="modal hidden">
    <div class="modal-content">
        <span class="close" id="close-owners-modal" onclick="closeOwnersModal()">&times;</span>
...
<!-- Modal for Customers -->
<div id="customers-modal" class="modal hidden">
    <div class="modal-content">
        <span class="close" id="close-customers-modal" onclick="closeCustomersModal()">&times;</span>
        <h2>All Customers</h2>
...
document.addEventListener("DOMContentLoaded", function() {
    // Show the owners modal
    function showOwnersModal() {
        document.getElementById('owners-modal').classList.remove('hidden');
    }

    // Close the owners modal
    function closeOwnersModal() {
        document.getElementById('owners-modal').classList.add('hidden');
    }

    // Show the customers modal
    function showCustomersModal() {
        document.getElementById('customers-modal').classList.remove('hidden');
    }

    // Close the customers modal
    function closeCustomersModal() {
        document.getElementById('customers-modal').classList.add('hidden');
    }

    // Attach click event listeners to buttons
    document.getElementById('show-owners-btn').addEventListener('click', showOwnersModal);
    document.getElementById('show-customers-btn').addEventListener('click', showCustomersModal);

    // Close modals when clicking the close button
    document.getElementById('close-owners-modal').addEventListener('click', closeOwnersModal);
    document.getElementById('close-customers-modal').addEventListener('click', closeCustomersModal);
});
</script>
